...
\lstinputlisting[language=C++]{code-snippets/fibonacci.cpp}
...
\lstinputlisting[language=C++]{code-snippets/LongestIncreasingSubsequence.cpp}

\subsection{Max 1D Range Sum}
\lstinputlisting[language=C++]{code-snippets/kadanesalgorithm.cpp}
...
\lstinputlisting[language=C++]{code-snippets/kruskal.cpp}
